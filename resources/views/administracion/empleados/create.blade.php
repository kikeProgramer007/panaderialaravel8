...
{{-- INICIO DEL CUERPO --}}
 ...
 <div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
            <form method="POST" action="{{asset('administracion/empleado/store')}}" autocomplete="off" class="needs-validation" novalidate>
              @csrf
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label>Sueldo</label> 
                                    <input class="form-control" id="sueldo" name="sueldo" type="number" pattern=".*\S+.*" placeholder="ingrese su sueldo "value="{{old('sueldo')}}" required />
                        ...
                        <div class="row">
                          ...
                          <div class="d-flex justify-content-end">
                              <div>
                                ...
                                <a href="{{route('empleado')}}" class= "btn btn-secondary btn-sm">Regresar</a>  
                              </div>
                          </div>
