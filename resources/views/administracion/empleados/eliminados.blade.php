              ...
              <div class="row mb-0">
                  ...
                  <div class="col-sm-6">
                      <ol class="breadcrumb float-sm-right">
                          ...
                          <li class="breadcrumb-item"><a href="{{route('empleado')}}">Empleados</a></li>
                                    ...
                                    @foreach ($empleados as $empleado)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="#" data-href="{{ asset('administracion/empleado/restaurar') }}/{{ $empleado->id }}" rel="tooltip" title="Restaurar" data-toggle="modal" data-target="#modal-confirma" class="btn btn-secondary btn-sm"><i class="fas fa-arrow-alt-circle-up"></i></a>
                                            </td> 
